          ...
          _vm.queryFlag
            ? _c(
                ...
                [
                  ...
                  _c(
                    "view",
                    { staticStyle: { zIndex: "9", width: "750rpx" } },
                    [
                      _c(
                        "u-text",
                        {
                        ...
                        [_vm._v(_vm._s(_vm.getsum1) + ".00 元")]
                      ),
                      _c(
                        "u-text",
                        {
                        ...
                        [_vm._v(_vm._s(_vm.getsum2) + ".00 元")]
                      ),
                      _c("u-image", {
                        staticStyle: { height: "160rpx" },
                        attrs: {
                        ...
                        return _c(
                          ...
                          [
                            ...
                            _c(
                              ...
                              [_vm._v("已申报税额: " + _vm._s(item.ysb) + "元")]
                            )
                          ]
                        )
                      })
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__f__) {Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nvar _lbPicker = _interopRequireDefault(__webpack_require__(/*! @/components/lb-picker */ 12));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\nvar _default = { components: { LbPicker: _lbPicker.default }, onPageScroll: function onPageScroll(e) {/* if(e.scrollTop > 120){\n                                                                                                      \tthis.scollFlag = true;\n                                                                                                      }else{\n                                                                                                      \tthis.scollFlag = false;\n                                                                                                      } */}, data: function data() {return { value1: '2020', value2: '', picture: '', showFlag: true, pickFlag: false, queryFlag: false, loadingFLag: false, list2: ['2019', '2020'], showFlagtz: false, xzxxDatas: [], scollFlag: false };}, filters: { clwz: function clwz(val) {if (val.length > 11) {return val.substr(0, 11) + '...';} else {return val;}} }, computed: { getsum1: function getsum1() {var sum1 = 0;this.xzxxDatas.forEach(function (item) {sum1 += parseInt(item.sr);});return sum1;}, getsum2: function getsum2() {var sum1 = 0;this.xzxxDatas.forEach(function (item) {sum1 += parseInt(item.ysb);});return sum1;} },\n  methods: {\n    jumpNs: function jumpNs() {\n      uni.hideTabBar();\n      this.showFlag = false;\n      this.showFlagtz = true;\n    },\n    jumpSy: function jumpSy() {\n      uni.showTabBar();\n      this.showFlag = true;\n      this.showFlagtz = false;\n    },\n    openPicker: function openPicker() {\n      this.$refs.picker1.show();\n    },\n    openCanlan: function openCanlan(e) {\n      this.value2 = e.value;\n    },\n    handleConfirm: function handleConfirm() {\n      this.value1 = this.value2;\n    },\n    handleCancel: function handleCancel() {\n      __f__(\"log\", 22222, \" at pages/tabBar/API/API.nvue:130\");\n    },\n    query: function query() {var _this = this;\n      this.showFlag = false;\n      this.showFlagtz = false;\n      this.queryFlag = true;\n      this.loadingFLag = true;\n      uni.getStorage({\n        key: 'storage_key',\n        success: function success(res) {\n          _this.xzxxDatas = res.data;\n          __f__(\"log\", res.data, \" at pages/tabBar/API/API.nvue:141\");\n        } });\n\n      setTimeout(function () {\n        _this.loadingFLag = false;\n      }, 500);\n    },\n    returnQuery: function returnQuery() {\n      this.showFlag = false;\n      this.showFlagtz = true;\n      this.queryFlag = false;\n    } } };exports.default = _default;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 6)[\"default\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///74\n");
